...
void init()
	{
		...
		cout << endl << endl;
		cout << "\t\t\t   Bienvenidos al Hotel de los Anders " << endl;
...
int  salir()
	{
		...
		cout << endl;
		cout << "\n\t\t\t  Christian Javier Rivera Amaya " << endl;
		cout << "\n\t\t\t  Jose Alberto Rodriguez " << endl;
		cout << "\n\t\t\t  Juan Carlos Maldonado" << endl;
		cout << "\n\t\t\t  Ana Belen Alarcon " << endl;
		cout << "\n\t\t\t  Maria Teresa Molina " << endl;
